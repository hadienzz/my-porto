    ...
    return (
        <div className="px-3 sm:px-5 md:px-7 lg:px-9 pt-20 md:flex justify-center md:max-w-[1200px] items-center overflow-hidden mx-auto">
            ...
            <div className="relative w-full overflow-hidden">
                <div className="absolute inset-0 z-10 pointer-events-none bg-gradient-to-r from-white via-white/0.5 to-white" />
                <ul className="flex animate-infinite-scroll whitespace-nowrap relative z-0 will-change-transform gap-20 w-[200%]">
